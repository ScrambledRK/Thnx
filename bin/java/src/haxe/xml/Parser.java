...
public class Parser extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_haxe_xml_Parser(haxe.xml.Parser __temp_me139)
	{
	}
	...
	public static haxe.root.Xml parse(java.lang.String str, java.lang.Object strict)
	{
		...
		boolean __temp_strict137 = ( (haxe.lang.Runtime.eq(strict, null)) ? (false) : (haxe.lang.Runtime.toBool(strict)) );
		...
		haxe.xml.Parser.doParse(str, __temp_strict137, 0, doc);
	...
	public static int doParse(java.lang.String str, boolean strict, java.lang.Object p, haxe.root.Xml parent)
	{
		...
		int __temp_p138 = ( (haxe.lang.Runtime.eq(p, null)) ? (0) : (((int) (haxe.lang.Runtime.toInt(p)) )) );
		...
		int c = 0;
		//line 80 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
		if (( __temp_p138 < str.length() )) 
		{
			//line 80 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
			c = ((int) (str.charAt(__temp_p138)) );
		}
		else
		{
			//line 80 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
			...
			switch (state)
			{
				...
				case 13:
				{
					...
					if (( c == 60 )) 
					{
						...
						buf.addSub(str, start, ( __temp_p138 - start ));
				...
				case 17:
				{
					...
					if (__temp_stmt1) 
					{
						...
						haxe.root.Xml child1 = haxe.root.Xml.createCData(haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start )));
					...
					switch (c)
					{
						case 33:
						{
							...
							if (( __temp_stmt7 == 91 )) 
							{
								...
								if ( ! (haxe.lang.Runtime.valEq(haxe.lang.StringExt.substr(str, __temp_p138, 6).toUpperCase(), "CDATA[")) ) 
								{
							...
							else
							{
								...
								if (__temp_stmt8) 
								{
									...
									if ( ! (haxe.lang.Runtime.valEq(haxe.lang.StringExt.substr(str, ( __temp_p138 + 2 ), 6).toUpperCase(), "OCTYPE")) ) 
									{
				...
				case 3:
				{
					...
					if ( ! ((( ( ( ( ( ( ( ( c >= 97 ) && ( c <= 122 ) ) || ( ( c >= 65 ) && ( c <= 90 ) ) ) || ( ( c >= 48 ) && ( c <= 57 ) ) ) || ( c == 58 ) ) || ( c == 46 ) ) || ( c == 95 ) ) || ( c == 45 ) ))) ) 
					{
						...
						xml = haxe.root.Xml.createElement(haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start )));
				...
				case 5:
				{
					...
					if ( ! ((( ( ( ( ( ( ( ( c >= 97 ) && ( c <= 122 ) ) || ( ( c >= 65 ) && ( c <= 90 ) ) ) || ( ( c >= 48 ) && ( c <= 57 ) ) ) || ( c == 58 ) ) || ( c == 46 ) ) || ( c == 95 ) ) || ( c == 45 ) ))) ) 
					{
						...
						tmp = haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start ));
				...
				case 9:
				{
					...
					__temp_p138 = haxe.xml.Parser.doParse(str, strict, __temp_p138, xml);
				...
				case 10:
				{
					...
					if ( ! ((( ( ( ( ( ( ( ( c >= 97 ) && ( c <= 122 ) ) || ( ( c >= 65 ) && ( c <= 90 ) ) ) || ( ( c >= 48 ) && ( c <= 57 ) ) ) || ( c == 58 ) ) || ( c == 46 ) ) || ( c == 95 ) ) || ( c == 45 ) ))) ) 
					{
						...
						java.lang.String v = haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start ));
				...
				case 15:
				{
					...
					if (__temp_stmt20) 
					{
						...
						{
							//line 296 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
							haxe.root.Xml xml1 = haxe.root.Xml.createComment(haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start )));
							//line 296 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
					...
					else
					{
						...
						else
						{
							...
							if (( ( c == 62 ) && ( nbrackets == 0 ) )) 
							{
								...
								{
									//line 307 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
									haxe.root.Xml xml2 = haxe.root.Xml.createDocType(haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start )));
									//line 307 "C:\\Apps\\Haxe\\haxe\\std\\haxe\\xml\\Parser.hx"
				...
				case 14:
				{
					...
					if (__temp_stmt26) 
					{
						...
						java.lang.String str1 = haxe.lang.StringExt.substr(str, ( start + 1 ), ( ( __temp_p138 - start ) - 2 ));
				...
				case 18:
				{
					...
					if (( c == 59 )) 
					{
						...
						java.lang.String s = haxe.lang.StringExt.substr(str, start, ( __temp_p138 - start ));
