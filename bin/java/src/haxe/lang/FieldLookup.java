...
public class FieldLookup extends haxe.lang.HxObject
{
	...
	public FieldLookup()
	{
		//line 28 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		haxe.lang.FieldLookup.__hx_ctor_haxe_lang_FieldLookup(this);
	}
	
	
	public static void __hx_ctor_haxe_lang_FieldLookup(haxe.lang.FieldLookup __temp_me144)
	{
	}
	...
	{
		//line 41 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int min = 0;
		//line 42 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		int max = length;
		//line 44 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		while (( min < max ))
		{
			//line 46 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			int mid = ((int) (( (( max + min )) / 2 )) );
			//line 47 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			int classify = hash.compareTo(hashs[mid]);
			//line 48 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			if (( classify < 0 )) 
			{
				//line 50 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
				max = mid;
			}
			else
			{
				//line 51 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
				if (( classify > 0 )) 
				{
					//line 52 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
					min = ( mid + 1 );
				}
				else
				{
					//line 54 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
					return mid;
				}
		...
		//line 58 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		return  ~ (min) ;
	}
	...
	{
		//line 62 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 63 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 67 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 68 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = ((double) (0) );
	}
	...
	{
		//line 72 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 73 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 121 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		{
			//line 121 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 122 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		{
			//line 122 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
			double[] a1 = a;
			//line 122 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 123 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
		{
			//line 123 "C:\\Apps\\Haxe\\haxe\\std\\java\\internal\\FieldLookup.hx"
