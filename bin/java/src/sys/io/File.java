...
public class File extends haxe.lang.HxObject
{
	...
	public static void __hx_ctor_sys_io_File(sys.io.File __temp_me162)
	{
	}
	...
	public static sys.io.FileInput read(java.lang.String path, java.lang.Object binary)
	{
		...
		boolean __temp_binary161 = ( (haxe.lang.Runtime.eq(binary, null)) ? (true) : (haxe.lang.Runtime.toBool(binary)) );
